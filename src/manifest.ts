  ...
  instanceConfigSchema: {
    ...
    properties: {
      slackBotToken: {
        ...
        description:
          "Bot token from api.slack.com (starts with xoxb-). The bot must have chat:write and channels:read scopes.",
      },
      paperclipUrl: {
        type: "string",
        title: "Paperclip URL",
      ...
      events: {
        ...
        description:
          "Toggle and route each event type to Slack channels. Channels can be names (#general) or IDs (C0123456).",
        properties: {
          "issue.created": {
            type: "object",
            title: "Issue Created",
